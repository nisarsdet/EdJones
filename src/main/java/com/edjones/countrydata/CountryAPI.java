package com.edjones.countrydata;
...
import com.edjones.utils.Config;
...
public class CountryAPI {
	...
	public String getCapitalByCountryCode(String countryCode) {
		...
		try {
			...
			if (response.getStatusCode() != HttpStatus.SC_OK) {
				logger.error("Error response : " + response.getStatusCode() + " for input " + countryCode);
			} else {
	...
	public Map<String, String> getCapitalByCountryName(String countryName) {
		...
		try {
			...
			if (response.getStatusCode() != HttpStatus.SC_OK) {
				logger.error("Error response : " + response.getStatusCode() + " for input " + countryName);
	...
	public String getCapitalByFullCountryName(String countryName) {
		String capital = null;
		Response response = null;
		...
		try {
			...
			logger.error("Error in hitting endpoint " + baseURL + "/name/" + countryName + "?fullText=true", e);
		}
